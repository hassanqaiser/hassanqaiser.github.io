...
var ChatSidebar = (function () {
    ...
    ChatSidebar.prototype.ngOnInit = function () {
        var $chatContainer = jQuery('layout').addClass('chat-sidebar-container');
...
var routes = [
    { path: '', component: layout_component_1.Layout, children: [
            ...
            { path: 'another-page', loadChildren: function () { return __webpack_require__.e/* System.import */(5).then(__webpack_require__.bind(null, "./src/app/another/another.module.ts")).then(function (mod) { return (mod.__esModule && mod.default) ? mod.default : mod; }); } },
        ] }
];
